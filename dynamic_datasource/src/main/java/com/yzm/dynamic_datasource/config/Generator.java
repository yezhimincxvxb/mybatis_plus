package com.yzm.dynamic_datasource.config;
...
public class Generator {
    ...
    //生成文件指定在哪个目录下
    private static final String baoPath = "com.yzm.dynamic_datasource";
    private static final String module = "dynamic_datasource";
    //数据源连接
    private static final String driverName = "com.mysql.cj.jdbc.Driver";
    private static final String url = "jdbc:mysql://192.168.145.11:3306/demo?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
